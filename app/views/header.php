				...
				<div class="col-md-3 logo_agile">
					<h1 class="text-center">
						<a href="index.html" class="font-weight-bold font-italic">
							<img src="/public/img/logo2.png" alt=" " class="img-fluid">Electro Store
						</a>
					</h1>
				</div>
				<!-- //logo -->
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto text-center mr-xl-5">
						...
						<li class="nav-item dropdown mr-lg-2 mb-lg-0 mb-2">
							...
							<div class="dropdown-menu">
								<div class="agile_inner_drop_nav_info p-4">
									<h5 class="mb-3">Router wifi, Switch</h5>
									<div class="row">
										<div class="col-sm-6 multi-gd-img">
											<ul class="multi-column-dropdown">
												<li>
													<a href="product.html">Bộ phát wifi</a>
												</li>
												<li>
													<a href="product.html">Bộ mesh wifi</a>
												</li>
											</ul>
										</div>
										<div class="col-sm-6 multi-gd-img">
											<ul class="multi-column-dropdown">
												<li>
													<a href="product.html">Switch 5 port</a>
												</li>
												<li>
													<a href="product.html">Switch 8 port</a>
												</li>
												<li>
													<a href="product.html">Switch 16 port</a>
												</li>
												<li>
													<a href="product.html">Switch 24 port</a>
												</li>
											</ul>
										</div>
									</div>
						...
						<li class="nav-item dropdown mr-lg-2 mb-lg-0 mb-2">
							...
							<div class="dropdown-menu">
								<div class="agile_inner_drop_nav_info p-4">
									<h5 class="mb-3">Các loại máy tính</h5>
									<div class="row">
										<div class="col-sm-6 multi-gd-img">
											<ul class="multi-column-dropdown">
												<li>
